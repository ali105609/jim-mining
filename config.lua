Config = {
	...
	setMiningTable = {	-- Set rarity of ore spawn for AltMining
		...
		{ name = "ironore", 		rarity = "rare", 		prop = "k4mb1_ironore2", },
		{ name = "leadore", 		rarity = "rare", 		prop = "k4mb1_leadore2", },
		{ name = "sulfurore", 		rarity = "rare", 		prop = "cs_x_rubweec", },
		{ name = "copperore", 		rarity = "rare", 		prop = "k4mb1_copperore2", },
